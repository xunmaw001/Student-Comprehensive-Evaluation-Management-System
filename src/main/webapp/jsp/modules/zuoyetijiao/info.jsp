...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<button class="btn-upload" id="zuoye">点击下载</button>
									</div>
									<div class="form-group col-md-6">
									<label>提交日期</label>

									<input id="tijiaoriqi" name="tijiaoriqi" class="form-control" v-model="ruleForm.tijiaoriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>教师工号</label>
	...
	<script>
		...
		function setDownloadBtn(){
			var zuoyeUrl = "download('" + ruleForm.zuoye + "')";
			$("#zuoye").attr("onclick",zuoyeUrl);
		}			
		//设置音视频播放链接

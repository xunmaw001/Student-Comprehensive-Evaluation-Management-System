...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>作业提交管理</span></li>
								<li class="breadcrumb-item active"><span>作业提交列表</span></li>
							</ol>
						</div>
					</div>
				</div>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>作业</th>
											<th onclick="sort('tijiaoriqi')">提交日期<i id="tijiaoriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zuoyeCell  = document.createElement('td');

						  var zuoyeFile = document.createElement('button');
			  zuoyeFile.setAttribute('class','btn-table')
			  zuoyeFile.innerHTML = '下载';
			  var zuoyeFileAttr = "download('" + item.zuoye + "')"
			  zuoyeFile.setAttribute('onclick',zuoyeFileAttr);
        	          zuoyeCell.appendChild(zuoyeFile);


			row.appendChild(zuoyeCell);
			var tijiaoriqiCell  = document.createElement('td');

						  tijiaoriqiCell.innerHTML = item.tijiaoriqi;


			row.appendChild(tijiaoriqiCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("zuoyetijiao/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("zuoyetijiao/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"zuoyetijiao");

...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学生管理</span></li>
								<li class="breadcrumb-item active"><span>学生列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="xueshengxingmingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#xueshengxingmingSearch').val() != null && $('#xueshengxingmingSearch').val() != ''){
				searchForm.xueshengxingming ="%" +  $('#xueshengxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xuesheng/page","GET",{
				...
				xueshengxingming : searchForm.xueshengxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xuesheng");

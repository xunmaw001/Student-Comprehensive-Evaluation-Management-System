		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑通知公告</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>通知公告管理</span></li>
								<li class="breadcrumb-item active"><span>编辑通知公告</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">通知公告信息</h3>
									...
									<div class="form-group col-md-6">
										...
										<div id="faburiqiDate" class="input-append date form_datetime">
											...
											<div class="form-group  col-md-12">
												<label>内容</label>
												<div><div class="upload"><input id="neirongupload" name="file" type="file">选择文件</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tongzhigonggao/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("tongzhigonggao/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tongzhigonggao/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("tongzhigonggao"+colName,"GET",{

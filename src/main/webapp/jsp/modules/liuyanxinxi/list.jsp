...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">留言信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>留言信息管理</span></li>
								<li class="breadcrumb-item active"><span>留言信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">留言信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										标题
									</label>
									<input type="text" id="biaotiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										教师工号
									</label>
									<input type="text" id="jiaoshigonghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										学号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>留言内容</th>
											<th onclick="sort('liuyanshijian')">留言时间<i id="liuyanshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#jiaoshigonghaoSearch').val() != null && $('#jiaoshigonghaoSearch').val() != ''){
				searchForm.jiaoshigonghao ="%" +  $('#jiaoshigonghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("liuyanxinxi/page","GET",{
				...
				jiaoshigonghao : searchForm.jiaoshigonghao,	
		...
		function setDataRow(item,number){
			...
			var liuyanneirongCell  = document.createElement('td');

						  if(item.liuyanneirong != null && item.liuyanneirong != "" && item.liuyanneirong.length >= 11){
			  	liuyanneirongCell.innerHTML = item.liuyanneirong.substring(0, 10) + "..."; 
			  }else{
			  	liuyanneirongCell.innerHTML = item.liuyanneirong;
			  }


			row.appendChild(liuyanneirongCell);
			var liuyanshijianCell  = document.createElement('td');

						  liuyanshijianCell.innerHTML = item.liuyanshijian;


			row.appendChild(liuyanshijianCell);
		...
		function sh(){
			...
			httpJson("liuyanxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");

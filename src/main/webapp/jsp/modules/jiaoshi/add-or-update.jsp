...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑教师</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>任教科目</label>
										<input id="renjiaokemu" name="renjiaokemu" class="form-control" placeholder="任教科目">
									</div>
									<div class="form-group col-md-6">
										<label>联系电话</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#renjiaokemu").val(ruleForm.renjiaokemu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.renjiaokemu != null && res.data.renjiaokemu != ''){

					$("#renjiaokemu").val(res.data.renjiaokemu);
					}

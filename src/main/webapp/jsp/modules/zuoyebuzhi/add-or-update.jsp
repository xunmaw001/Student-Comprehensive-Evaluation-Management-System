						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>作业要求</label>
										<textarea name="zuoyeyaoqiu" class="form-control" id="zuoyeyaoqiu" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>发布日期</label>
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("zuoyebuzhi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("zuoyebuzhi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#zuoyeyaoqiu").val(ruleForm.zuoyeyaoqiu);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zuoyeyaoqiu != null && res.data.zuoyeyaoqiu != ''){

					$("#zuoyeyaoqiu").val(res.data.zuoyeyaoqiu);
					}
